...
function sessionvaltozok(){
  echo "id_of_map: ".$_SESSION["id_of_map"]."<br/>";
  echo "id_of_user: ".$_SESSION["id_of_user"]."<br/>";
  echo "id_of_player: ".$_SESSION["id_of_player"]."<br/>";
  echo "id_of_game: ".$_SESSION["id_of_game"]."<br/>";
}

function JatekListaMegjelenites($JatekLista){
  
  echo "Játékban<br/>";
  echo "----------<br/>";
  foreach ($JatekLista as $value) {
    echo "Id: ".$value."<br/>";
  }
...
<div style='margin-left: auto; margin-right: auto; width: 65em; padding-left: 1em; padding-bottom: 3em; padding-top: 2em; background-color: #e5dbcf;'>
  ...
  <fieldset style='height: 20em; width: 15em; background-color: #F2EDDE; float: left;'>
    <legend>FőMenü</legend>
      <div>
        ...
        <p><a href='existingGame.php'>Futó Játékok</a></p>
  ...
  <legend>Futó Játékok</legend>
  <?php $JatekLista = $Jatek->getFutoJatekListam();
        JatekListaMegjelenites($JatekLista);
  ?>        
  </fieldset>
