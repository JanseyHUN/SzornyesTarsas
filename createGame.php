...
<head>
      ...
      function AdatKuldes(){
    	  ...
    	  var JatekNeve = document.getElementById("gamename").value;
    	  var JatekJelszo = document.getElementById("password").value;    	  
    	    
          var kuldesDiv = document.getElementById("generateFormDiv").innerHTML = '<form id="generateForm" method="post" action="generateGame.php"><input name="karakter" type="hidden" value="'+karakterId+'"><input name="jatekneve" type="hidden" value="'+JatekNeve+'"><input name="jatekjelszo" type="hidden" value="'+JatekJelszo+'"></form>';
...
<div style='margin-left: auto; margin-right: auto; width: 65em; padding-left: 1em; padding-bottom: 3em; padding-top: 2em; background-color: #e5dbcf;'>
  ...
  <legend>Tartalom</legend>
    <fieldset style="margin-bottom: 1em; text-align: center;">
      Válassz magadnak játékost és készíts egy játékot!
    </fieldset>
  ...
  <div style="width: 15em; height: 2em;  float: left; margin-left: 2em; padding-top: 0.6em; background-color: #9D919E;">
    ...
    <div style="margin-bottom: 2em; padding-bottom: 0.6em; padding-top: 0.6em; background-color: #D5C4CA;">
      Játék Neve:<br/>
      <input type='text' name='gamename' id='gamename' maxlength="50" /><br/>
      Jelszó:<br/>
    ...
    <div style="height: 15.5em; background-color: #D5C4CA;">
      ...
      <p><b id="player1">1. Játékos</b></p>
      <p id="player2">2. Játékos</p>
      <p id="player3">3. Játékos</p>
      <p id="player4">4. Játékos</p>
    </div>
  </div>
  ...
  <div style="width: 10em; height: 2em; float: left; margin-left: 2em; height: auto; background-color: #9D919E; padding: 0em; padding-top: 0.6em; text-align: center;">
    ...
    <div id="generateFormDiv" style="background-color: #D5C4CA; margin-bottom: 1em;">
      <button onclick="AdatKuldes();">GENERÁLÁS</button>    
    </div>
