...
if ($Jatek->JatekIndithatosagEllenorzes()) {
	altalanos::RedirectToURL("playGame.php");
    exit;;
}
...
<head>
      ...
      function AdatKuldes(){
    	  ...
    	  var kuldesDiv = document.getElementById("disconnectFormDiv").innerHTML = '<form id="disconnectForm" method="post" action="joinGame.php"><input id="jatekosid" name="jatekosid" type="hidden" value="'+karakter+'"><input id="jatekid" name="jatekid" type="hidden" value="'+jatekid+'"></form>';
...
<div style='margin-left: auto; margin-right: auto; width: 65em; padding-left: 1em; padding-bottom: 3em; padding-top: 2em; background-color: #e5dbcf;'>
  ...
  <div style="width: 10em; height: 2em; float: left; margin-left: 2em; height: auto; background-color: #9D919E; padding: 0em; padding-top: 0.6em; text-align: center;">
    ...
    <div style="background-color: #D5C4CA;">
      <a href="refreshjoinedGame.php">FRISSÍT</button>
    </div>
  </div>
